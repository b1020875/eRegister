...
<div class="fieldcontain ${hasErrors(bean: enrollmentInstance, field: 'enrolledstudent', 'error')} required">
	<label for="enrolledstudent">
		<g:message code="enrollment.enrolledstudent.label" default="Enrolledstudent" />
		<span class="required-indicator">*</span>
	</label>
	<g:select id="enrolledstudent" name="enrolledstudent.id" from="${uk.ac.shu.webarch.eregister.Student.list()}" optionKey="id" required="" value="${enrollmentInstance?.enrolledstudent?.id}" class="many-to-one"/>
</div>

<div class="fieldcontain ${hasErrors(bean: enrollmentInstance, field: 'regclass', 'error')} required">
	<label for="regclass">
		<g:message code="enrollment.regclass.label" default="Regclass" />
		<span class="required-indicator">*</span>
	</label>
