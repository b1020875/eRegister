...
<html id="EditEnrollment">
	...
	<body>
		<a href="#edit-enrollment" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-enrollment" class="content scaffold-edit" role="main">
			...
			<ul class="errors" role="alert">
				<g:eachError bean="${enrollmentInstance}" var="error">
